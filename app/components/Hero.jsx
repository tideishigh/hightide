...
export default function Hero({ header, para, imgSrc, imgAlt }) {
  return (
    <div className="relative isolate overflow-hidden mx-auto max-w-7xl px-6 lg:px-8 py-32 items-center min-h-[50rem] flex flex-col md:flex-row">
      ...
      <div className="w-full flex flex-col my-auto gap-8">
        <h2 className="text-4xl font-bold text-black sm:text-6xl whitespace-pre max-w-4xl text-wrap">{header}</h2>
        <p className="tracking-wide text-neutral text-xl leading-10 max-w-2xl">{para}</p>
      </div>
      <div>
